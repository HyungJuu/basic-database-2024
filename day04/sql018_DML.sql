...
-- 속성리스트 생략가능
-- 단, 컬럼의 수만큼 입력(완전일치), 불일치시 입력 오류
INSERT INTO Book
     VALUES (12, '스포츠 의학2', '한솔의학서적', 90000);

-- NULL값으로 지정가능한 값 생략가능
-- 단, 값을 생략하려면 컬럼을 지정해줘야 함
...
-- 특수 INSERT 
-- INSERT INTO ... SELECT ...
-- Imported_Book 테이블의 데이터를 Book에 바로 추가
INSERT INTO Book(bookid, bookname, publisher, price)
...
-- 수정(UPDATE)
-- 사전준비
-- 이전의 Customer 테이블의 내용을 CustomerNew로 복사
